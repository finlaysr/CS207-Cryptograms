...
class LoginSignUp extends JPanel {
    ...
    class Login extends JPanel {
        ...
        public void loginButton(){
            ...
            User newUser = App.getUsers().filter(user -> user.getUsername().equals(usernameField.getText())).findFirst().orElse(null);
            if  (newUser != null) {
...
class Scoreboard extends JPanel {
    ...
    public Scoreboard() {
        ...
        String[][] data = App.getUsers().map(user -> new String[]{user.getUsername(), String.valueOf(user.getGamesWon())}).toArray(String[][]::new);
